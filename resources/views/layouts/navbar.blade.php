...
<body>
  ...
  <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow">
    ...
    <div class="navbar-nav">
      <div class="nav-item text-nowrap ms-3 me-3 mb-2">
        <a class="nav-link px-3 btn btn-outline-primary" role="button" href="login.php">LOGIN</a>
      </div>
    </div>
  </header>
    ...
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
        <div class="position-sticky pt-3 sidebar-sticky">
          <a href="/" class="d-flex align-items-center mt-2 mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
